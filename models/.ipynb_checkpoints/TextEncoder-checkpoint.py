...
class BertEncoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        bert_type = config.bert_encoder.type #'bert-base-uncased'
        dropout = config.training.dropout #dropout = 0.2
        ...
        # else:
        #     for name, param in self.bert_encoder.named_parameters():
        #         if name.startswith(('bert_encoder.encoder.layer.9','bert_encoder.encoder.layer.10','bert_encoder.encoder.layer.11')):
